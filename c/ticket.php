  ...
  <body>
    ...
    <div class="main_content_wsb" id="main_content">
      ...
      <div class="topnavticket">
        <li class="navholder">
          <a class="navticket" href="/DNA/ticket.php?action=create">Create</a>
          <a class="navticket" href="/DNA/ticket.php?action=approval">Approval</a>
          <a class="navticket" href="/DNA/ticket.php?action=confirm">Confirmation</a>
          <a class="navticket" href="/DNA/ticket.php?action=status">Status</a>
        </li>
      </div>
