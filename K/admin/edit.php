...
if(isset($_POST["edit"])) {
    $edit_select = "SELECT item, required_quantity, supplier, total_price, price from request where request_id = $edit_id";
...
//     if ($count_exist == "0") {
//         $request_insert = "INSERT INTO request (`item`, `unit`, `price`, `supplier`, `required_quantity`, `requestor`, `date_request`, `request_id`, `approval`, `status`, `total_price`) VALUES ('$item', '$unit', '$price', '$supplier', '$required_quantity', '$requestor', current_timestamp(), '$generated', false, false, '$total')";
...
//         $request_insert = "INSERT INTO request (`item`, `unit`, `price`, `supplier`, `required_quantity`, `requestor`, `date_request`, `request_id`, `approval`, `status`, `total_price`) VALUES ('$item', '$unit', '$price', '$supplier', '$required_quantity', '$requestor', current_timestamp(), '$generated_repeat', false, false, '$total')";
//         $request_insert_query = mysqli_query($db_conn, $request_insert);
//     }
// }
?>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../S/css/edit.css?v=<?php echo time(); ?>">
