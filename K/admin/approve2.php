...
include "/var/www/html/RNA/includes/D/config.php";
  ...
  function fetch_data($db, $tableName, $columns){
   ...
   $query = "SELECT * FROM `users` WHERE `username` = '$username' AND `userlevel` = 'PIC'";
...
<html>
  ...
  <input type="button" id="btnUser" name="submitnowUser" value="Submit" style="display: none"/>
            ...
            ?>
            <?php $startDate = new DateTime(); $startDATE =  $startDate->format('Y-m-d'); echo $startDATE ?>" name="StartDate" onchange="filterMonth();">
