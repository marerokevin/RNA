  ...
  <body>
    ...
    <div class="main_content_wsb" id="main_content">
      ...
      <div class="inventorynav">
        <li class="navholder">
          <a onclick="tablet4()" id="status" class="navticket-off" href="/RNA/K/item-request.php?action=status">Status</a>
          <a onload="tablet1()" id="create" class="navticket-off" href="/RNA/K/item-request.php?action=request">Request Item</a>
        </li>
      </div>
